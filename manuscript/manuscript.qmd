...
Model 5 - Multi-level hierarchical linear model with partial pooling across $MBR$ numerator groups (Rrs411, Rrs443, Rrs489, Rrs510) for both model mean and model variance.  Model parameter prior mean and variance have Gaussian and Exponential hyperpriors similar to Model 2s.
:::
