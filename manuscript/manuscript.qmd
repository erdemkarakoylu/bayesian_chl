...
This model can be represented by the following set of probabilistic equations:
...
\begin{align*}
    ...
    \mu &= \alpha + \beta_1 X + \beta_2 X^2 + \beta_3 X^3 + \beta_4 X^4 \\
    \sigma &\sim \text{Gamma}(2, 2) \\
    \text{likelihood} &\sim \text{TruncatedNormal}(\mu, \sigma, -3, 3.3)
\end{align*}

::: {#fig-oc6-struct}

![](images/oc6_structure.svg)
